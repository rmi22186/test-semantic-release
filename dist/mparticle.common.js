...
function _objectSpread(a) { for (var b, c = 1; c < arguments.length; c++)
    b = null == arguments[c] ? {} : arguments[c], c % 2 ? ownKeys(Object(b), !0).forEach(function (c) { _defineProperty(a, c, b[c]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(b)) : ownKeys(Object(b)).forEach(function (c) { Object.defineProperty(a, c, Object.getOwnPropertyDescriptor(b, c)); }); return a; }
...
function _unsupportedIterableToArray(a, b) { if (a) {
    if ("string" == typeof a)
...
function _arrayLikeToArray(a, b) { (null == b || b > a.length) && (b = a.length); for (var c = 0, d = Array(b); c < b; c++)
    d[c] = a[c]; return d; }
...
function _createSuper(a) { var b = _isNativeReflectConstruct(); return function () { var c, d = _getPrototypeOf(a); if (b) {
    var e = _getPrototypeOf(this).constructor;
    c = Reflect.construct(d, arguments, e);
}
else
    c = d.apply(this, arguments); return _possibleConstructorReturn(this, c); }; }
...
var BatchUploader = /*#__PURE__*/ function () {
    ...
    return _createClass(a, [{ key: "addEventListeners", value: function addEventListeners() { var a = this; document.addEventListener("visibilitychange", function () { a.prepareAndUpload(!1, a.isBeaconAvailable()); }), window.addEventListener("beforeunload", function () { a.prepareAndUpload(!1, a.isBeaconAvailable()); }), window.addEventListener("pagehide", function () { a.prepareAndUpload(!1, a.isBeaconAvailable()); }); } }, { key: "isBeaconAvailable", value: function isBeaconAvailable() { return !!navigator.sendBeacon; } }, { key: "queueEvent", value: function queueEvent(a) { a && (this.pendingEvents.push(a), this.mpInstance.Logger.verbose("Queuing event: ".concat(JSON.stringify(a))), this.mpInstance.Logger.verbose("Queued event count: ".concat(this.pendingEvents.length)), (!this.batchingEnabled || Types.TriggerUploadType[a.EventDataType]) && this.prepareAndUpload(!1, !1)); } /**
            ...
            */ function () { var b = _asyncToGenerator(/*#__PURE__*/ regenerator.mark(function b(c, d) { var e, f, g, h, i, j, k, l = this; return regenerator.wrap(function (b) { for (;;)
                switch (b.prev = b.next) {
                    case 0: return e = this.mpInstance.Identity.getCurrentUser(), f = this.pendingEvents, this.pendingEvents = [], g = a.createNewUploads(f, e, this.mpInstance), g && g.length && (h = this.pendingUploads).push.apply(h, _toConsumableArray(g)), i = this.pendingUploads, this.pendingUploads = [], b.next = 9, this.upload(this.mpInstance.Logger, i, d);
                    case 9: j = b.sent, j && j.length && (k = this.pendingUploads).unshift.apply(k, _toConsumableArray(j)), c && setTimeout(function () { l.prepareAndUpload(!0, !1); }, this.uploadIntervalMillis);
                    case 12:
                    case "end": return b.stop();
                } }, b, this); })); return function prepareAndUpload() { return b.apply(this, arguments); }; }() }, { key: "upload", value: function () { var b = _asyncToGenerator(/*#__PURE__*/ regenerator.mark(function b(c, d, e) { var f, g, h, j, k; return regenerator.wrap(function (b) { for (;;)
                switch (b.prev = b.next) {
                    case 0:
                        if (d && !(1 > d.length)) {
                            b.next = 2;
...
_defineProperty(BatchUploader, "CONTENT_TYPE", "text/plain;charset=UTF-8"), _defineProperty(BatchUploader, "MINIMUM_INTERVAL_MILLIS", 500);
var AsyncUploader = function a(b, c) { _classCallCheck(this, a), _defineProperty(this, "url", void 0), _defineProperty(this, "logger", void 0), this.url = b, this.logger = c; }, FetchUploader = /*#__PURE__*/ function (a) { function b() { return _classCallCheck(this, b), c.apply(this, arguments); } _inherits(b, a); var c = _createSuper(b); return _createClass(b, [{ key: "upload", value: function () { var a = _asyncToGenerator(/*#__PURE__*/ regenerator.mark(function a(b) { var c; return regenerator.wrap(function (a) { for (;;)
            switch (a.prev = a.next) {
                case 0: return a.next = 2, fetch(this.url, b);
                case 2: return c = a.sent, a.abrupt("return", c);
                case 4:
                case "end": return a.stop();
            } }, a, this); })); return function upload() { return a.apply(this, arguments); }; }() }]), b; }(AsyncUploader), XHRUploader = /*#__PURE__*/ function (a) { function b() { return _classCallCheck(this, b), c.apply(this, arguments); } _inherits(b, a); var c = _createSuper(b); return _createClass(b, [{ key: "upload", value: function () { var a = _asyncToGenerator(/*#__PURE__*/ regenerator.mark(function a(b) { var c; return regenerator.wrap(function (a) { for (;;)
            switch (a.prev = a.next) {
                case 0: return a.next = 2, this.makeRequest(this.url, this.logger, b.body);
                case 2: return c = a.sent, a.abrupt("return", c);
                case 4:
                case "end": return a.stop();
            } }, a, this); })); return function upload() { return a.apply(this, arguments); }; }() }, { key: "makeRequest", value: function () { var a = _asyncToGenerator(/*#__PURE__*/ regenerator.mark(function a(b, c, d) { var e; return regenerator.wrap(function (a) { for (;;)
            switch (a.prev = a.next) {
...
var DataPlanMatchType = { ScreenView: "screen_view", CustomEvent: "custom_event", Commerce: "commerce", UserAttributes: "user_attributes", UserIdentities: "user_identities", ProductAction: "product_action", PromotionAction: "promotion_action", ProductImpression: "product_impression" }, KitBlocker = /*#__PURE__*/ function () {
    function a(b, c) {
        ...
        if (_classCallCheck(this, a), _defineProperty(this, "dataPlanMatchLookups", {}), _defineProperty(this, "blockEvents", !1), _defineProperty(this, "blockEventAttributes", !1), _defineProperty(this, "blockUserAttributes", !1), _defineProperty(this, "blockUserIdentities", !1), _defineProperty(this, "kitBlockingEnabled", !1), _defineProperty(this, "mpInstance", void 0), b && !b.document)
    ...
    return _createClass(a, [{ key: "addToMatchLookups", value: function addToMatchLookups(a) {
                var b, c, d;
